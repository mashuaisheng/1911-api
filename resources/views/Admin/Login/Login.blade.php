        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{url('/user/logins')}}" method="post">
                        <fieldset>
                            <div class="form-group">
                                <input class="form-control" placeholder="请输入名称" name="user_name"  >
                            </div>
                            <div class="form-group">
                                <input class="form-control" placeholder="请输入名称" name="password" type="password">
                            </div>
                            {{--<div class="checkbox">--}}
                                {{--<label>--}}
                                    {{--<input name="remember" type="checkbox" v>记住密码--}}
                            ...
                            <div style="text-align:right;">
                                <a href="{{url('/user/Registered')}}" class="btn ">没有阅读账号密码？点击注册</a>
                            </div>
